...
func (s *Sheesh) Delete(ctx context.Context) error {
...
func (s *Sheesh) Load(ctx context.Context) (string, error) {
...
func (s *Sheesh) Sanitize(ctx context.Context) (interface{}, error) {
...
// BaseBased Thread-safe implementation using the double-checked locking pattern.
...
// CustomMalding i will mass NOT be explaining this in the PR
