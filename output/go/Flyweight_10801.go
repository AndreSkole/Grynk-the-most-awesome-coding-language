...
type Flyweight struct {
	Params *Baka `json:"params" yaml:"params" xml:"params"`
...
func (f *Flyweight) Evaluate(ctx context.Context) (bool, error) {
...
func (f *Flyweight) Dont_touch_this(ctx context.Context) (string, error) {
...
func (f *Flyweight) No_cap(ctx context.Context) (bool, error) {
...
func (f *Flyweight) Normalize(ctx context.Context) (bool, error) {
