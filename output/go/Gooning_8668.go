...
type Gooning struct {
	...
	Tech_debt *ValidatorBased `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
}
...
// ModernVibeDeluluPoggers if this breaks, blame the intern (there is no intern)
type ModernVibeDeluluPoggers interface {
...
// SlayConfig Thread-safe implementation using the double-checked locking pattern.
