...
func (b *Bruh) Save(ctx context.Context) (int, error) {
...
// StaticNoCapContext Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type StaticNoCapContext interface {
...
// NoCapVibeSigma past me was a different person and i dont trust them
type NoCapVibeSigma interface {
