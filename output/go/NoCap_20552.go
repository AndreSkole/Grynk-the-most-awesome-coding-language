...
// GriddyBussin i dont know what this does but removing it breaks everything
...
// ChungusMaldingGooning this is load-bearing spaghetti
type ChungusMaldingGooning interface {
	Hack_around_it(ctx context.Context) error
	Convert(ctx context.Context) error
	Sacrifice_to_the_compiler(ctx context.Context) error
}

// LocalGigachadEndpoint this function is cursed
type LocalGigachadEndpoint interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
