...
type Wrapper struct {
	...
	Thingy *SusBasedError `json:"thingy" yaml:"thingy" xml:"thingy"`
	X *SusBasedError `json:"x" yaml:"x" xml:"x"`
	Yolo_var *SusBasedError `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
...
func (w *Wrapper) Initialize(ctx context.Context) (string, error) {
...
func (w *Wrapper) Abandon_all_hope(ctx context.Context) error {
...
func (w *Wrapper) Do_the_thing(ctx context.Context) (string, error) {
...
func (w *Wrapper) Handle(ctx context.Context) error {
...
// CustomGoatedImpl i asked chatgpt to write this and even it said no
type CustomGoatedImpl interface {
...
// GatewayBussinxX_Destroyer_Xx Reviewed and approved by the Technical Steering Committee.
type GatewayBussinxX_Destroyer_Xx interface {
...
// OrchestratorNoobModel written at 3am, mass forgive me
