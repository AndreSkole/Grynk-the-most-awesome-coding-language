...
func (c *Connector) Ship_it(ctx context.Context) (bool, error) {
...
// GlizzyKind this is load-bearing spaghetti
...
// HitsSlapsAura Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type HitsSlapsAura interface {
...
// SigmaFlyweight abandon all hope ye who enter here
type SigmaFlyweight interface {
	Please_work(ctx context.Context) error
