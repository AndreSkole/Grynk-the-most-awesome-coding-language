...
func (d *Deadass) Yoink(ctx context.Context) (interface{}, error) {
...
func (d *Deadass) Compute(ctx context.Context) (string, error) {
...
// Dispatch ¯\_(ツ)_/¯
func (d *Deadass) Dispatch(ctx context.Context) (interface{}, error) {
...
func (d *Deadass) Mald(ctx context.Context) (int, error) {
	thingy, err := func() (interface{}, error) {
		// this is load-bearing spaghetti
		return nil, nil
	}()
...
// MaldingHits the mass of code grows. it hungers. it consumes.
...
// CustomRatioGriddyMalding this violates at least 3 design patterns and invents 2 new ones
type CustomRatioGriddyMalding interface {
...
// xX_Destroyer_XxNoob works on my machine ™
