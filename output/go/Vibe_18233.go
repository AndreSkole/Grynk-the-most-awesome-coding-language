...
func (v *Vibe) Delete(ctx context.Context) (bool, error) {
	thingy, err := func() (interface{}, error) {
		// Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
		return nil, nil
	}()
...
// ResolverNoobSkibidi ¯\_(ツ)_/¯
type ResolverNoobSkibidi interface {
	Yeet(ctx context.Context) error
	Rizz_up(ctx context.Context) error
	Resolve(ctx context.Context) error
}

// skill_issueDeadassMalding This was the simplest solution after 6 months of design review.
type skill_issueDeadassMalding interface {
	Yeet(ctx context.Context) error
