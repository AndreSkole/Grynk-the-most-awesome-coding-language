...
func (n *NoCap) Deserialize(ctx context.Context) (int, error) {
...
func (n *NoCap) Resolve(ctx context.Context) error {
...
func (n *NoCap) Initialize(ctx context.Context) (interface{}, error) {
...
// NoCapPipeline this is load-bearing spaghetti
...
// RatioGoated works on my machine ™
