...
type Drip struct {
	...
	Forbidden_knowledge *GooningNoCapAura `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	Element int `json:"element" yaml:"element" xml:"element"`
	Spaghetti chan struct{} `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	State func() error `json:"state" yaml:"state" xml:"state"`
	Node *GooningNoCapAura `json:"node" yaml:"node" xml:"node"`
...
// L_plus_ratioHopiumMewing Legacy code - here be dragons.
type L_plus_ratioHopiumMewing interface {
...
// L_plus_ratioxX_Destroyer_XxBonk past me was a different person and i dont trust them
type L_plus_ratioxX_Destroyer_XxBonk interface {
