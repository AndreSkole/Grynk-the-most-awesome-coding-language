...
func (s *Sus) Handle(ctx context.Context) (int, error) {
...
// DeadassNoCapGriddy no tests needed, it's perfect (copium)
type DeadassNoCapGriddy interface {
...
// NoCapYoinkBaka past me was a different person and i dont trust them
type NoCapYoinkBaka interface {
