...
func (b *Baka) Sanitize(ctx context.Context) error {
...
// GatewayMaldingEdging Reviewed and approved by the Technical Steering Committee.
type GatewayMaldingEdging interface {
...
// LegacyVibePipelineUtils if you're reading this, turn back now
type LegacyVibePipelineUtils interface {
