...
func (d *Dispatcher) Deserialize(ctx context.Context) (string, error) {
...
// MapperCompositeService i asked chatgpt to write this and even it said no
type MapperCompositeService interface {
