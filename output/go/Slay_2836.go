...
func (s *Slay) Initialize(ctx context.Context) error {
...
// InterceptorOhio the code is documentation enough (it is not)
...
// DynamicSerializer if you're reading this, turn back now
