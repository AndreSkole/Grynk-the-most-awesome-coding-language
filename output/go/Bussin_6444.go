...
// BaseInterceptorYoink certified bruh moment
type BaseInterceptorYoink interface {
...
// RatioInfo this function is cursed
type RatioInfo interface {
...
// CoreAggregatorRatio the mass of code grows. it hungers. it consumes.
