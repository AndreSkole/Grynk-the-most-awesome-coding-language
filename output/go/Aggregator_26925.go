...
func (a *Aggregator) Initialize(ctx context.Context) (interface{}, error) {
...
func (a *Aggregator) Todo_fix_later(ctx context.Context) (interface{}, error) {
...
// GigachadSerializer if this breaks, blame the intern (there is no intern)
type GigachadSerializer interface {
...
// EnhancedGlizzySkibidi if this breaks, blame the intern (there is no intern)
type EnhancedGlizzySkibidi interface {
