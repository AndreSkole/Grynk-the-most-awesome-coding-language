...
type Rizz struct {
	...
	This_shouldnt_work *HopiumBussin `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (r *Rizz) Convert(ctx context.Context) (interface{}, error) {
...
// DefaultAuraCringe This is a critical path component - do not remove without VP approval.
type DefaultAuraCringe interface {
...
// GriddyProvider This was the simplest solution after 6 months of design review.
