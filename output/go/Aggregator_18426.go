...
func (a *Aggregator) Go_outside(ctx context.Context) (string, error) {
...
func (a *Aggregator) Sync(ctx context.Context) (string, error) {
...
// DynamicGatewayYoinkSlaps certified bruh moment
type DynamicGatewayYoinkSlaps interface {
