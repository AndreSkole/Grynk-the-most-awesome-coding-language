...
type Vibe struct {
	...
	Stuff *ConverterDeadass `json:"stuff" yaml:"stuff" xml:"stuff"`
...
func (v *Vibe) Transform(ctx context.Context) (string, error) {
...
// ChungusInitializer i will mass NOT be explaining this in the PR
type ChungusInitializer interface {
...
// CommandGlizzySlaps TODO: Refactor this in Q3 (written in 2019).
type CommandGlizzySlaps interface {
	Works_on_my_machine(ctx context.Context) error
...
// GlizzyBonkDescriptor skill issue if you can't read this
type GlizzyBonkDescriptor interface {
...
// HopiumBridge skill issue if you can't read this
type HopiumBridge interface {
