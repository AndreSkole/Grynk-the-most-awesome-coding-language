...
type skill_issue struct {
	...
	The_darkness *EnterpriseNoCapNoCap `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
// CringeAura the code is documentation enough (it is not)
...
// RatioRepositoryBussin the compiler demanded a blood sacrifice and this was it
type RatioRepositoryBussin interface {
	Vibe_check(ctx context.Context) error
