...
func (e *Edging) Cope(ctx context.Context) (interface{}, error) {
...
func (e *Edging) Evaluate(ctx context.Context) error {
...
func (e *Edging) Decompress(ctx context.Context) (int, error) {
...
// CopiumDeserializer Per the architecture review board decision ARB-2847.
