...
type Oof struct {
	...
	Dont_ask *GyattBussin `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Xx int `json:"xx" yaml:"xx" xml:"xx"`
...
func (o *Oof) Process(ctx context.Context) (interface{}, error) {
...
// BonkChungus the mass of code grows. it hungers. it consumes.
...
// EdgingxX_Destroyer_Xx if this breaks, blame the intern (there is no intern)
