...
func (g *Gateway) Sacrifice_to_the_compiler(ctx context.Context) (string, error) {
...
func (g *Gateway) Works_on_my_machine(ctx context.Context) (bool, error) {
...
func (g *Gateway) Handle(ctx context.Context) (interface{}, error) {
...
func (g *Gateway) Marshal(ctx context.Context) (string, error) {
...
func (g *Gateway) Dont_touch_this(ctx context.Context) (string, error) {
	god_object, err := func() (interface{}, error) {
		// this violates at least 3 design patterns and invents 2 new ones
		return nil, nil
	}()
...
// BruhGooningDrip i dont know what this does but removing it breaks everything
type BruhGooningDrip interface {
