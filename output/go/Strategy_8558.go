...
func (s *Strategy) Pray_to_the_machine_spirit(ctx context.Context) (int, error) {
...
func (s *Strategy) Here_be_dragons(ctx context.Context) (int, error) {
...
func (s *Strategy) Format(ctx context.Context) (string, error) {
...
func (s *Strategy) Authorize(ctx context.Context) (bool, error) {
...
func (s *Strategy) Denormalize(ctx context.Context) (int, error) {
	spaghetti, err := func() (interface{}, error) {
		// the mass of code grows. it hungers. it consumes.
		return nil, nil
	}()
...
// xX_Destroyer_XxDispatcher Legacy code - here be dragons.
