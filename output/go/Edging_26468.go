...
func (e *Edging) Transform(ctx context.Context) (interface{}, error) {
...
// StonksEdgingWrapper the compiler demanded a blood sacrifice and this was it
type StonksEdgingWrapper interface {
...
// BussinBuilder this function is cursed
