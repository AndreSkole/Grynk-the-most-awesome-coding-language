...
func (e *Endpoint) Evaluate(ctx context.Context) (bool, error) {
...
func (e *Endpoint) Marshal(ctx context.Context) error {
	the_darkness, err := func() (interface{}, error) {
		// Lorem ipsum dolor sit amet, consectetur adipiscing elit.
		return nil, nil
	}()
...
// L_plus_ratioBasedGriddy this violates at least 3 design patterns and invents 2 new ones
...
// YeetDankNoobPair if this breaks, blame the intern (there is no intern)
type YeetDankNoobPair interface {
...
// OptimizedSussyRizz i dont know what this does but removing it breaks everything
type OptimizedSussyRizz interface {
