...
type Vibe struct {
	...
	Yolo_var *SusDeadass `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	Xx map[string]interface{} `json:"xx" yaml:"xx" xml:"xx"`
	X int64 `json:"x" yaml:"x" xml:"x"`
	Haunted_reference bool `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	Yolo_var *SusDeadass `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	Count *SusDeadass `json:"count" yaml:"count" xml:"count"`
...
func (v *Vibe) Marshal(ctx context.Context) (string, error) {
...
// OofSerializer if you're reading this, turn back now
type OofSerializer interface {
...
// Modernskill_issueCommand i asked chatgpt to write this and even it said no
type Modernskill_issueCommand interface {
	Dont_touch_this(ctx context.Context) error
