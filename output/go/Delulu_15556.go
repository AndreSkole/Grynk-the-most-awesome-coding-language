...
func (d *Delulu) Delete(ctx context.Context) (interface{}, error) {
...
// StandardVisitorCoordinatorAdapter i will mass NOT be explaining this in the PR
type StandardVisitorCoordinatorAdapter interface {
...
// StonksMewingCopium certified bruh moment
type StonksMewingCopium interface {
