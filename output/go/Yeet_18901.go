...
type Yeet struct {
	...
	Legacy_pain *OofStonksBruh `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (y *Yeet) Mald(ctx context.Context) (string, error) {
...
// xX_Destroyer_XxGooningSusKind the code is documentation enough (it is not)
type xX_Destroyer_XxGooningSusKind interface {
...
// LegacyCringeHelper ¯\_(ツ)_/¯
type LegacyCringeHelper interface {
