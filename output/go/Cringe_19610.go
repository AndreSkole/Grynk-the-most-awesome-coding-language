...
func (c *Cringe) Rizz_up(ctx context.Context) (string, error) {
...
// StandardGyattBussinPipeline this violates at least 3 design patterns and invents 2 new ones
type StandardGyattBussinPipeline interface {
