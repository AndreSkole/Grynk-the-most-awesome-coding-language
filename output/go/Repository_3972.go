...
type Repository struct {
	...
	Bruh *DefaultWrapperAggregator `json:"bruh" yaml:"bruh" xml:"bruh"`
	The_darkness interface{} `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Whatever []interface{} `json:"whatever" yaml:"whatever" xml:"whatever"`
	Spaghetti *DefaultWrapperAggregator `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (r *Repository) Lgtm(ctx context.Context) (interface{}, error) {
...
func (r *Repository) Dispatch(ctx context.Context) (bool, error) {
...
// FanumBussin TODO: figure out why this works
...
// BakaBruh the mass of code grows. it hungers. it consumes.
type BakaBruh interface {
...
// ManagerDelegateCopiumUtils i will mass NOT be explaining this in the PR
type ManagerDelegateCopiumUtils interface {
