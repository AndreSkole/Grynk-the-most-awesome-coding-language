...
func (g *Griddy) Cry(ctx context.Context) (bool, error) {
...
// DefaultYoinkIteratorDrip the mass of code grows. it hungers. it consumes.
type DefaultYoinkIteratorDrip interface {
	Trust_me_bro(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
	Cope(ctx context.Context) error
}

// VisitorYeet i will mass NOT be explaining this in the PR
