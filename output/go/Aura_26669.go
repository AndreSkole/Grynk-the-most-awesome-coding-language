...
type Aura struct {
	...
	Eldritch_data *StaticGooning `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	The_darkness bool `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Buffer *sync.Mutex `json:"buffer" yaml:"buffer" xml:"buffer"`
	Element *StaticGooning `json:"element" yaml:"element" xml:"element"`
	Value int64 `json:"value" yaml:"value" xml:"value"`
	Xxx *StaticGooning `json:"xxx" yaml:"xxx" xml:"xxx"`
...
// EnhancedFacadeL_plus_ratio Legacy code - here be dragons.
type EnhancedFacadeL_plus_ratio interface {
