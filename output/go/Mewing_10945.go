...
type Mewing struct {
	...
	Xx *Cringeskill_issue `json:"xx" yaml:"xx" xml:"xx"`
...
func (m *Mewing) Trust_me_bro(ctx context.Context) error {
...
func (m *Mewing) Invalidate(ctx context.Context) error {
...
// GooningFlyweight works on my machine ™
...
// ModuleResult TODO: figure out why this works
...
// YoinkL_plus_ratioGriddy ¯\_(ツ)_/¯
type YoinkL_plus_ratioGriddy interface {
