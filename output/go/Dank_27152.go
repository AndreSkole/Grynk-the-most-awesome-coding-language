...
// OptimizedGooningGlizzySheesh if you're reading this, turn back now
type OptimizedGooningGlizzySheesh interface {
...
// CustomGriddy the code is documentation enough (it is not)
