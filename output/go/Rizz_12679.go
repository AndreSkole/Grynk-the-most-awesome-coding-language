...
type Rizz struct {
	...
	Xx *YeetHitsAura `json:"xx" yaml:"xx" xml:"xx"`
...
func (r *Rizz) Sync(ctx context.Context) (bool, error) {
...
// HopiumSusGriddy certified bruh moment
type HopiumSusGriddy interface {
...
// SlayConfigurator no tests needed, it's perfect (copium)
