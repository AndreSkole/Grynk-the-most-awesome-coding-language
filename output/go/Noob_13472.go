...
type Noob struct {
	...
	Bruh *Bruh `json:"bruh" yaml:"bruh" xml:"bruh"`
...
// DynamicSlayGooning i will mass NOT be explaining this in the PR
type DynamicSlayGooning interface {
...
// ModernEdging i will mass NOT be explaining this in the PR
