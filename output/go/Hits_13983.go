...
func (h *Hits) Idk_what_this_does(ctx context.Context) (bool, error) {
...
// SusSusMalding if you're reading this, turn back now
type SusSusMalding interface {
...
// GriddyDank vibe coded, do not question
...
// BaseLigmaSheesh this is load-bearing spaghetti
type BaseLigmaSheesh interface {
	Lgtm(ctx context.Context) error
	No_cap(ctx context.Context) error
