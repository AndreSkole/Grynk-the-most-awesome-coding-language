...
type PoggersFanum struct {
	...
	Element *Oofskill_issueDankKind `json:"element" yaml:"element" xml:"element"`
...
func (p *PoggersFanum) Vibe_check(ctx context.Context) (string, error) {
...
func (p *PoggersFanum) Trust_me_bro(ctx context.Context) (int, error) {
...
func (p *PoggersFanum) No_cap(ctx context.Context) (string, error) {
...
func (p *PoggersFanum) Works_on_my_machine(ctx context.Context) (interface{}, error) {
...
// BasedMalding this is load-bearing spaghetti
