...
func (c *Chain) Aggregate(ctx context.Context) (bool, error) {
	spaghetti, err := func() (interface{}, error) {
		// this violates at least 3 design patterns and invents 2 new ones
		return nil, nil
	}()
...
// GenericBasedConverterEndpoint this is load-bearing spaghetti
type GenericBasedConverterEndpoint interface {
...
// DripVibeCringe works on my machine ™
type DripVibeCringe interface {
	No_cap(ctx context.Context) error
