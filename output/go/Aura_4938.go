...
type Aura struct {
	...
	Cursed_value *GenericTransformer `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
// InternalSussyCoordinator this is load-bearing spaghetti
type InternalSussyCoordinator interface {
	Seethe(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
}

// AuraBeanStonks vibe coded, do not question
type AuraBeanStonks interface {
