...
// DeluluDeluluContext no tests needed, it's perfect (copium)
type DeluluDeluluContext interface {
...
// LigmaYoink past me was a different person and i dont trust them
type LigmaYoink interface {
	Resolve(ctx context.Context) error
	Load(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
}

// BruhFacadeProviderConfig the compiler demanded a blood sacrifice and this was it
type BruhFacadeProviderConfig interface {
...
// CoreFacadeDelulu this violates at least 3 design patterns and invents 2 new ones
type CoreFacadeDelulu interface {
