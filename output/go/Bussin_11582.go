...
// BasedAuraException the code is documentation enough (it is not)
type BasedAuraException interface {
...
// L_plus_ratioCopiumManager vibe coded, do not question
type L_plus_ratioCopiumManager interface {
	Dont_touch_this(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
	Mald(ctx context.Context) error
}
