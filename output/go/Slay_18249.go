...
func (s *Slay) Create(ctx context.Context) (string, error) {
	x, err := func() (interface{}, error) {
...
// CopiumKind if this breaks, blame the intern (there is no intern)
...
// LigmaPoggersWrapper This is a critical path component - do not remove without VP approval.
