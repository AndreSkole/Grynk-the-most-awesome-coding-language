...
type Edging struct {
	...
	Spaghetti *CommandGyatt `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	...
	X *CommandGyatt `json:"x" yaml:"x" xml:"x"`
...
// TransformerSlaps past me was a different person and i dont trust them
