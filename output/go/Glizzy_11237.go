...
func (g *Glizzy) Unmarshal(ctx context.Context) (string, error) {
...
// FactoryRizzGyatt This was the simplest solution after 6 months of design review.
type FactoryRizzGyatt interface {
...
// NoCapPair TODO: Refactor this in Q3 (written in 2019).
type NoCapPair interface {
...
// Deluluno_bitches the compiler demanded a blood sacrifice and this was it
