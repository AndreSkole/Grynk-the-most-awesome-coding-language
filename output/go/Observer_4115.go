...
// StaticAuraDeluluDelulu DO NOT TOUCH - last person who modified this quit
type StaticAuraDeluluDelulu interface {
	Lgtm(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
	No_cap(ctx context.Context) error
}

// CloudRizzLigma i dont know what this does but removing it breaks everything
type CloudRizzLigma interface {
