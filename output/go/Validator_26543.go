...
// ChungusValue Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type ChungusValue interface {
	Works_on_my_machine(ctx context.Context) error
	Pray_to_the_machine_spirit(ctx context.Context) error
	Mald(ctx context.Context) error
}

// LegacyNoobStonks if you're reading this, turn back now
type LegacyNoobStonks interface {
