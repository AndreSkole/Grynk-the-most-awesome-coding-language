...
type NoCap struct {
	This_shouldnt_work *StandardWrapperNoCapDrip `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Legacy_pain *StandardWrapperNoCapDrip `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
// SigmaBaka no tests needed, it's perfect (copium)
