...
type Slay struct {
	Temp_but_permanent *YeetEntity `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (s *Slay) Yoink(ctx context.Context) (int, error) {
...
func (s *Slay) Denormalize(ctx context.Context) (string, error) {
...
// OofHopiumStonks Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type OofHopiumStonks interface {
...
// BussinGyatt works on my machine ™
