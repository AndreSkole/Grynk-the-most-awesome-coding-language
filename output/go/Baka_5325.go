...
type Baka struct {
	...
	Dont_ask *StonksBased `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Yolo_var context.Context `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	The_darkness *StonksBased `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
// SlapsChungusGriddy ¯\_(ツ)_/¯
type SlapsChungusGriddy interface {
...
// InternalMaldingRizzHits i dont know what this does but removing it breaks everything
type InternalMaldingRizzHits interface {
