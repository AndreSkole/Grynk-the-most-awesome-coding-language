...
func (p *Provider) Here_be_dragons(ctx context.Context) (interface{}, error) {
...
// WrapperBussin the mass of code grows. it hungers. it consumes.
type WrapperBussin interface {
...
// ChungusDank no tests needed, it's perfect (copium)
...
// CloudRizzAuraCopium Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type CloudRizzAuraCopium interface {
