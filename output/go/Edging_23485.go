...
func (e *Edging) Compute(ctx context.Context) (bool, error) {
...
// VibeMapperChungusSpec this function is cursed
type VibeMapperChungusSpec interface {
...
// DefaultGriddyProxy DO NOT TOUCH - last person who modified this quit
type DefaultGriddyProxy interface {
	Touch_grass(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
