...
type Noob struct {
	...
	Legacy_pain *FanumMewing `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (n *Noob) Handle(ctx context.Context) (string, error) {
...
// ConverterLigmaDelulu i asked chatgpt to write this and even it said no
type ConverterLigmaDelulu interface {
...
// skill_issueRizz certified bruh moment
