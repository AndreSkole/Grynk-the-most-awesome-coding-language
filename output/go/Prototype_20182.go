...
func (p *Prototype) Sync(ctx context.Context) (interface{}, error) {
...
func (p *Prototype) Initialize(ctx context.Context) error {
...
// BonkEntity i will mass NOT be explaining this in the PR
...
// GoatedMalding this violates at least 3 design patterns and invents 2 new ones
