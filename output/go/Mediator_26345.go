...
type Mediator struct {
	...
	Entry *GlizzyBussin `json:"entry" yaml:"entry" xml:"entry"`
...
func (m *Mediator) Compress(ctx context.Context) (interface{}, error) {
...
func (m *Mediator) Please_work(ctx context.Context) (interface{}, error) {
...
// OofBussinYeet i asked chatgpt to write this and even it said no
type OofBussinYeet interface {
