...
// ConfiguratorHits i dont know what this does but removing it breaks everything
type ConfiguratorHits interface {
	Yeet(ctx context.Context) error
	Handle(ctx context.Context) error
	No_cap(ctx context.Context) error
}

// StaticGlizzySkibidiMewing this is load-bearing spaghetti
type StaticGlizzySkibidiMewing interface {
