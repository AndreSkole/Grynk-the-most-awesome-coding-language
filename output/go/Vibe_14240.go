...
func (v *Vibe) Compress(ctx context.Context) (interface{}, error) {
...
// FanumHopium past me was a different person and i dont trust them
...
// GriddyxX_Destroyer_XxBussin if this breaks, blame the intern (there is no intern)
type GriddyxX_Destroyer_XxBussin interface {
...
// IteratorProcessorDeadass skill issue if you can't read this
type IteratorProcessorDeadass interface {
