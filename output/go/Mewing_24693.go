...
type Mewing struct {
	...
	Count *Converter `json:"count" yaml:"count" xml:"count"`
...
func (m *Mewing) Marshal(ctx context.Context) error {
...
func (m *Mewing) Load(ctx context.Context) (string, error) {
...
// Modernskill_issueNoCapTransformer This satisfies requirement REQ-ENTERPRISE-4392.
type Modernskill_issueNoCapTransformer interface {
