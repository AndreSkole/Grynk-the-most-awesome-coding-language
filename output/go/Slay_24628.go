...
type Slay struct {
	...
	Cursed_value *SlapsBruh `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
func (s *Slay) Unmarshal(ctx context.Context) (bool, error) {
...
// EndpointSheeshYoink written at 3am, mass forgive me
type EndpointSheeshYoink interface {
