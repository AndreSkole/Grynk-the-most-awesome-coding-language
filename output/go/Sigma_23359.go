...
func (s *Sigma) Process(ctx context.Context) error {
...
func (s *Sigma) Create(ctx context.Context) (string, error) {
...
// VibeSlay if you're reading this, turn back now
type VibeSlay interface {
