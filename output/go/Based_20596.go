...
func (b *Based) Update(ctx context.Context) (interface{}, error) {
...
// Lgtm ¯\_(ツ)_/¯
func (b *Based) Lgtm(ctx context.Context) error {
...
// SlayRegistryCopium this violates at least 3 design patterns and invents 2 new ones
type SlayRegistryCopium interface {
	Do_the_thing(ctx context.Context) error
	Do_the_thing(ctx context.Context) error
