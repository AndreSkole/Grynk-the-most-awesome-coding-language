...
func (i *Interceptor) Authenticate(ctx context.Context) error {
...
// LigmaRecord if this breaks, blame the intern (there is no intern)
...
// SingletonDank i will mass NOT be explaining this in the PR
type SingletonDank interface {
	Touch_grass(ctx context.Context) error
