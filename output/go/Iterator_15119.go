...
func (i *Iterator) Here_be_dragons(ctx context.Context) (int, error) {
...
// Bussin_fr ¯\_(ツ)_/¯
func (i *Iterator) Bussin_fr(ctx context.Context) (bool, error) {
...
// CringeCringeRizz Reviewed and approved by the Technical Steering Committee.
type CringeCringeRizz interface {
...
// BaseGooningPrototype past me was a different person and i dont trust them
type BaseGooningPrototype interface {
