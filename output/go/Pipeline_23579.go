...
func (p *Pipeline) Todo_fix_later(ctx context.Context) error {
...
func (p *Pipeline) Decompress(ctx context.Context) (bool, error) {
...
func (p *Pipeline) Delete(ctx context.Context) (bool, error) {
...
// BussinOhio TODO: Refactor this in Q3 (written in 2019).
