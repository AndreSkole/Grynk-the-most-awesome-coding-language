...
func (r *Rizz) Resolve(ctx context.Context) (interface{}, error) {
...
// GooningSkibidi i will mass NOT be explaining this in the PR
...
// ModernBussinChungus skill issue if you can't read this
type ModernBussinChungus interface {
	Seethe(ctx context.Context) error
	Convert(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
}

// VisitorOofDank certified bruh moment
type VisitorOofDank interface {
