...
type Oof struct {
	...
	Cache_entry *GoatedDeluluType `json:"cache_entry" yaml:"cache_entry" xml:"cache_entry"`
	Xxx *GoatedDeluluType `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (o *Oof) Compress(ctx context.Context) (interface{}, error) {
...
func (o *Oof) Execute(ctx context.Context) (string, error) {
	legacy_pain, err := func() (interface{}, error) {
...
func (o *Oof) Cache(ctx context.Context) (bool, error) {
	legacy_pain, err := func() (interface{}, error) {
...
// StonksMapper works on my machine ™
