...
type Handler struct {
	...
	This_shouldnt_work *SkibidiCringeHitsBase `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (h *Handler) Parse(ctx context.Context) (int, error) {
	dont_ask, err := func() (interface{}, error) {
...
// GatewayProvider i dont know what this does but removing it breaks everything
...
// GigachadAuraGigachad ¯\_(ツ)_/¯
type GigachadAuraGigachad interface {
