...
func (y *Yoink) Decompress(ctx context.Context) (interface{}, error) {
...
// InterceptorBussin if you're reading this, turn back now
...
// DeluluResponse if this breaks, blame the intern (there is no intern)
