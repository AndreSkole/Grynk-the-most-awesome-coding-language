...
type Cringe struct {
	...
	Fix_me_please *PoggersGlizzy `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
}
...
func (c *Cringe) Sanitize(ctx context.Context) (interface{}, error) {
...
// VibeSigmaDank abandon all hope ye who enter here
type VibeSigmaDank interface {
	Here_be_dragons(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
	Bussin_fr(ctx context.Context) error
}

// BussinDeadassPoggers written at 3am, mass forgive me
