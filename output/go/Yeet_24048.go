...
func (y *Yeet) No_cap(ctx context.Context) (interface{}, error) {
...
// GyattMiddlewareBussinEntity the compiler demanded a blood sacrifice and this was it
type GyattMiddlewareBussinEntity interface {
...
// DistributedGigachad the code is documentation enough (it is not)
