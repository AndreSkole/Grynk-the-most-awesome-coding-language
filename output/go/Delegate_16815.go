...
// BasedEdgingProxy skill issue if you can't read this
type BasedEdgingProxy interface {
...
// DispatcherCoordinatorBasedImpl past me was a different person and i dont trust them
type DispatcherCoordinatorBasedImpl interface {
