...
// DeserializerSheesh if you're reading this, turn back now
type DeserializerSheesh interface {
...
// MaldingHitsL_plus_ratio This is a critical path component - do not remove without VP approval.
type MaldingHitsL_plus_ratio interface {
